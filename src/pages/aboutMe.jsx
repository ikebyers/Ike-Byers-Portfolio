...
const AboutMe = () => {
    return (
        <div className="about-me-container">
            ...
            <p>In both music and coding, I’ve found that creativity and technical skill go hand-in-hand. Just as producing a song requires technical ability, precision, effecient organization, and an ear for detail, coding demands focus and a willingness to experiment and find new innovative ways to accomplish a goal. My experience in music has taught me to approach each project with a combination of creativity, persistence, and a commitment to quality.</p>
